-- Update get_leads_data function to query from people table with role 'lead'
...
-- Update get_user_profile_data function to remove people_leads references
...
-- Update update_people_leads_field function to return error since leads table no longer exists
