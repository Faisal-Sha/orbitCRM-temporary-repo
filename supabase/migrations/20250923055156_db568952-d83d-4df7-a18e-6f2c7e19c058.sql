-- Step 1: Update get_user_profile_data function to remove people_leads dependency
...
-- Step 2: Update update_people_leads_field function to return error since leads functionality is removed
...
-- Step 3: Drop all RLS policies on people_leads table (if they exist)
DROP POLICY IF EXISTS "Users can create leads in their organization" ON public.people_leads;
DROP POLICY IF EXISTS "Users can delete leads in their organization" ON public.people_leads;
DROP POLICY IF EXISTS "Users can update leads in their organization" ON public.people_leads;
DROP POLICY IF EXISTS "Users can view leads in their organization" ON public.people_leads;

-- Step 4: Drop the people_leads table
