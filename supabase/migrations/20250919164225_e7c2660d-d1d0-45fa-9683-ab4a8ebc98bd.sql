-- Drop and recreate the update_people_emergency_field function with proper JSON return
DROP FUNCTION IF EXISTS public.update_people_emergency_field(uuid, text, text);
